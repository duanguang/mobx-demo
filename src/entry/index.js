...
ReactDOM.render(React.createElement(mobx_react_1.Provider, {store: todoIndex_1.default}, 
    React.createElement(react_router_1.Router, {history: react_router_1.hashHistory}, 
        React.createElement(react_router_1.Route, {breadcrumbName: "用户管理", path: "/", component: todoInput_1.TodoInput}), 
